...
def evaluate_motif_imagery_coverage(
    ...
    motif_overuse_penalty, motif_overused = calculate_overuse_penalty(motif_mentions, max_mentions_per_item=5)
    imagery_overuse_penalty, imagery_overused = calculate_overuse_penalty(imagery_mentions, max_mentions_per_item=4)
    ...
    final_score = overall_coverage * (1.0 - overall_overuse_penalty * 0.5) * (0.8 + overall_balance * 0.2)
