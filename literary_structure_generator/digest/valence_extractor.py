...
POSITIVE_WORDS = {
    "happy", "joy", "love", "wonderful", "great", "good", "beautiful", "amazing",
    "excellent", "fantastic", "perfect", "pleasant", "smile", "laugh", "delight",
    "hope", "bright", "warm", "kind", "gentle", "sweet", "calm", "peaceful",
}

NEGATIVE_WORDS = {
    "sad", "pain", "hurt", "terrible", "bad", "awful", "horrible", "ugly",
    "hate", "angry", "mad", "furious", "dark", "cold", "harsh", "cruel",
    "fear", "afraid", "scared", "worried", "anxious", "nervous", "sick",
    "death", "die", "blood", "wound", "scream", "cry", "tear",
}
...
def extract_valence_arc(
    ...
    valence_arc = {
        ...
        "overall_mean": sum(smoothed_valences) / len(smoothed_valences) if smoothed_valences else 0.0,
    }
